...
namespace forms.Compras
{
    public partial class frmProveedor : Form
    {
        ...
        public bool getValores()
        {
            ...
            if (frmComprasConsultaPersona.id_persona==0)
            {
                frmComprasConsultaPersona.id_persona=frmConsultaProveedor.id_persona;
            }

            if (frmConsultaEmpresa.id_empresa == 0)
            {
                frmConsultaEmpresa.id_empresa = frmConsultaProveedor.id_empresa;
            }
