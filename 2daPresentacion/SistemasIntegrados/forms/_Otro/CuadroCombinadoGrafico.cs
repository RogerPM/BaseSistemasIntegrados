...
namespace ComboxExtended
{
    ...
    /// </summary>
    public class CuadroCombinadoGrafico : ComboBox
    {
        private ComboCollection<ItemCuadroCombinado> _items;
        ...
        public new ComboCollection<ItemCuadroCombinado> Items
        {
            get { return _items; }
            set { _items = value; }
        }
