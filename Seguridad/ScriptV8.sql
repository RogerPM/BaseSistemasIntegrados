...
IdImagen	int references Seguridad.Imagen null,
Logo varchar(50),
Fondo varchar(50),
Logotipo image null,--usar
FechaInicioSistema datetime null,
Correo varchar(70) null,
SitioWeb varchar(70) null,
Descripcion varchar(250) null,
IdEstado int references Seguridad.Estado not null
)
go
...
CREATE TABLE Compras.Cotizacion --50%
(
Numero				int NOT NULL,
idEmpresa			int NOT NULL,
IdUsuario			int NOT NULL,
...
create table Compras.NotaDebito --ok
(
Numero				int				not null,
IdEmpresa			int				not null,        
IdUsuario			int				not null,
...
Fecha				date			NOT NULL,
FechaTransaccion	date			NOT NULL,
NumeroFactura		int				not null, --no es fk
Monto				numeric(10,0)	not null,
idFormaPago			int				not null,
Observaciones		varchar  (200)			,
foreign key (IdUsuario)references Seguridad.Usuario,
foreign key (IdEmpresa)references Seguridad.Empresa,
foreign key (NumeroDevolucion, idEmpresa) references Compras.DevolucionCompra, 
foreign key	(idFormaPago) references CuentasPorCobrar.FormaPago,
primary key(Numero,IdEmpresa)
)
go

create table Compras.DebitoDet --ok
(
Numero				int not null,
IdEmpresa			int not null,
linea				int not null,
...
PRINT N'N.Compras 80% falta que arreglen forma de pago'
