...
namespace forms
{
    public partial class frmPrincipal : DevExpress.XtraEditors .XtraForm
    {
        ...
        {
            if (MessageBox.Show("Desea salir del programa? ", "TECA™", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == System.Windows.Forms.DialogResult.Yes)
            {
            }
            else
            {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            if (BanderaCrecer)
                ...
                i = i - 100;
            panelControl1.Size = new Size(i, this.Size.Width);
            if (i >= 1424)
                timer1.Stop();
        }
